...
CREATE SEQUENCE public.consumer_seq
    INCREMENT 1
    START 4
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
(
    id integer NOT NULL DEFAULT nextval('consumer_seq'::regclass),
    name character varying(48) COLLATE pg_catalog."default" NOT NULL,
    lastname character varying(48) COLLATE pg_catalog."default" NOT NULL,
    dni integer NOT NULL,
    email character varying(128) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT "ux_consumer_dni	" UNIQUE (dni)
,
    CONSTRAINT ux_consumer_email UNIQUE (email)
,
    CONSTRAINT ux_consumer_phone UNIQUE (phone)
,
    CONSTRAINT fk_consumer_to_city_id FOREIGN KEY (city_id)
...
ALTER SEQUENCE public.contract_seq
    OWNER TO postgres;
...
(
    ...
    CONSTRAINT fk_contract_to_consumer_id FOREIGN KEY (consumer_id)
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk_contract_to_provider_id FOREIGN KEY (provider_id)
        REFERENCES public.provider (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
